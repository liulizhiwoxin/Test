...
namespace BuysingooShop.BLL
{
    ...
    public partial class user_message
    {
        ...
        /// <param name="field">字段（发件人/收件人）</param>
        /// <returns></returns>
        public bool Exists(int id, string user_name, string field)
        {
            return dal.Exists(id, user_name, field);
        }
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(BuysingooShop.Model.user_message model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(BuysingooShop.Model.user_message model)
        {
