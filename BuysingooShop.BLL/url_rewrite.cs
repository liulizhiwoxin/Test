...
namespace BuysingooShop.BLL
{
    public class url_rewrite
    {
        ...
        {
            Hashtable ht = _Cache.Get<Hashtable>(Vincent._DTcms.DTKeys.CACHE_SITE_URLS);
            if (ht == null)
            {
                _Cache.Insert(Vincent._DTcms.DTKeys.CACHE_SITE_URLS, dal.GetList(), Vincent._DTcms.Utils.GetXmlMapPath(Vincent._DTcms.DTKeys.FILE_URL_XML_CONFING));
                ht = _Cache.Get<Hashtable>(Vincent._DTcms.DTKeys.CACHE_SITE_URLS);
            }
            return ht;
        }
        ...
        {
            List<Model.url_rewrite> ls = _Cache.Get<List<Model.url_rewrite>>(Vincent._DTcms.DTKeys.CACHE_SITE_URLS_LIST);
            if (ls == null)
            {
                _Cache.Insert(Vincent._DTcms.DTKeys.CACHE_SITE_URLS_LIST, dal.GetList(""), Vincent._DTcms.Utils.GetXmlMapPath(Vincent._DTcms.DTKeys.FILE_URL_XML_CONFING));
                ls = _Cache.Get<List<Model.url_rewrite>>(Vincent._DTcms.DTKeys.CACHE_SITE_URLS_LIST);
            }
            return ls;
        }
