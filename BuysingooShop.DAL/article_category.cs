...
namespace BuysingooShop.DAL
{
    ...
    public partial class article_category
    {
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql.Append("channel_id,title,call_index,parent_id,class_list,class_layer,sort_id,link_url,img_url,img_url1,content,seo_title,seo_keywords,seo_description)");
                        ...
                        parameters[9].Value = model.img_url1;
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        parameters[9].Value = model.img_url1;
                        parameters[10].Value = model.content;
                        parameters[12].Value = model.seo_title;
                        parameters[12].Value = model.seo_keywords;
                        parameters[13].Value = model.seo_description;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,channel_id,title,call_index,parent_id,class_list,class_layer,sort_id,link_url,img_url,img_url1,content,seo_title,seo_keywords,seo_description from " + databaseprefix + "article_category ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,channel_id,title,call_index,parent_id,class_list,class_layer,sort_id,link_url,img_url,img_url,content,seo_title,seo_keywords,seo_description from " + databaseprefix + "article_category ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,channel_id,title,call_index,parent_id,class_list,class_layer,sort_id,link_url,img_url,img_url1,content,seo_title,seo_keywords,seo_description from " + databaseprefix + "article_category");
        ...
        /// <param name="channel_id">频道ID</param>
        /// <returns></returns>
        public DataTable GetLists(int parent_id, int channel_id)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,channel_id,title,call_index,parent_id,class_list,class_layer,sort_id,link_url,img_url,img_url1,content,seo_title,seo_keywords,seo_description from " + databaseprefix + "article_category");
            strSql.Append(" where channel_id=" + channel_id + " and parent_id=" + parent_id + " order by sort_id asc,id desc");
        ...
        private void GetChilds(DataTable oldData, DataTable newData, int parent_id, int channel_id)
        {
            ...
            for (int i = 0; i < dr.Length; i++)
            {
                ...
                row["img_url1"] = dr[i]["img_url1"].ToString();
