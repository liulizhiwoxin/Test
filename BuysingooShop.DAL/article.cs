...
namespace BuysingooShop.DAL
{
    ...
    public partial class article
    {
        ...
        public int Add(Model.article model)
        {
            ...
            strSql.Append("channel_id,category_id,brand_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,groupids_view,vote_id,is_top,is_red,is_hot,is_slide,is_sys,is_msg,user_name,add_time,update_time,sell_price,market_price,img_url1,goods_recomm1,goods_recomm2)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@goods_recomm1",SqlDbType.VarChar,50),
                    new SqlParameter("@goods_recomm2",SqlDbType.VarChar,50),
            ...
            parameters[15].Value = model.groupids_view;
            parameters[16].Value = model.vote_id;
            ...
            parameters[22].Value = model.is_msg;
            parameters[23].Value = model.user_name;
            parameters[24].Value = model.add_time;
            parameters[25].Value = model.update_time;
            parameters[26].Value = model.sell_price;
            parameters[27].Value = model.market_price;
            parameters[28].Value = model.img_url1;
            parameters[29].Value = model.goods_recomm1;
            parameters[30].Value = model.goods_recomm2;
            ...
            if (model.albums != null)
            {
                ...
                foreach (Model.article_albums modelt in model.albums)
                {
                    ...
                    strSql3.Append("article_id,thumb_path,original_path,remark,category_id,img_size)");
                    ...
                    SqlParameter[] parameters3 = {
                        ...
                        new SqlParameter("@category_id", SqlDbType.Int,4),
                        new SqlParameter("@img_size", SqlDbType.NVarChar,50)};
                    ...
                    parameters3[4].Value = modelt.category_id;
                    parameters3[5].Value = modelt.img_size;
            ...
            using (SqlConnection conn = new SqlConnection(DbHelperSQL.connectionString))
            {
                ...
                using (SqlTransaction trans = conn.BeginTransaction())
                {
                    try
                    {
                        ...
                        strSql.Append("goods_recomm1=@goods_recomm1,");
                        strSql.Append("goods_recomm2=@goods_recomm2");
                        strSql.Append(" where id=@id");
                        SqlParameter[] parameters = {
					            new SqlParameter("@channel_id", SqlDbType.Int,4),
					            new SqlParameter("@category_id", SqlDbType.Int,4),
                                ...
                                new SqlParameter("@sell_price", SqlDbType.Decimal,5),
                                new SqlParameter("@market_price", SqlDbType.Decimal,5),
                                new SqlParameter("@img_url1",SqlDbType.VarChar,255),
                                new SqlParameter("@goods_recomm1",SqlDbType.VarChar,50),
                                new SqlParameter("@goods_recomm2",SqlDbType.VarChar,50),
                                new SqlParameter("@id", SqlDbType.Int,4)};
                        parameters[0].Value = model.channel_id;
                        ...
                        if (model.fields.Count > 0)
                        {
                            ...
                            strSql2.Append(Vincent._DTcms.Utils.DelLastComma(strFieldName.ToString()));
                        ...
                        if (model.albums != null)
                        {
                            ...
                            foreach (Model.article_albums modelt in model.albums)
                            {
                                ...
                                if (modelt.id > 0)
                                {
                                    ...
                                    strSql3.Append("img_size=@img_size");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,channel_id,category_id,brand_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,groupids_view,vote_id,is_top,is_red,is_hot,is_slide,is_sys,is_msg,user_name,add_time,update_time,sell_price,market_price,img_url1,goods_recomm1,goods_recomm2");
            strSql.Append(" from " + databaseprefix + "article ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["goods_recomm1"].ToString() != "")
                {
                    model.goods_recomm1 = ds.Tables[0].Rows[0]["goods_recomm1"].ToString();
                }
                if (ds.Tables[0].Rows[0]["goods_recomm2"].ToString() != "")
                {
                    model.goods_recomm2 = ds.Tables[0].Rows[0]["goods_recomm2"].ToString();
                }
                #endregion
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    StringBuilder strSql2 = new StringBuilder();
                    strSql2.Append("select top 1 " + Vincent._DTcms.Utils.DelLastComma(sb.ToString()) + " from " + databaseprefix + "article_attribute_value ");
                    strSql2.Append(" where article_id=@article_id ");
                    SqlParameter[] parameters2 = {
					    new SqlParameter("@article_id", SqlDbType.Int,4)};
                    parameters2[0].Value = id;
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            //strSql.Append(" id,channel_id,category_id,brand_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,groupids_view,vote_id,is_top,is_red,is_hot,is_slide,is_sys,is_msg,user_name,add_time,update_time ");
            strSql.Append(" * FROM " + databaseprefix + "article ");
            //SELECT * FROM dt_article t1 INNER JOIN dbo.dt_article_attribute_value t2 ON t1.id=t2.article_id
            //strSql.Append(" * FROM dt_article t1 INNER JOIN dbo.dt_article_attribute_value t2 ON t1.id=t2.article_id ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetSreachPro(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" img_url,id,sell_price,title,market_price FROM " + databaseprefix + "article ");
        ...
        public DataSet GetListalbums(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" * ");
            strSql.Append(" FROM  dt_article Left JOIN dt_article_albums on dt_article.id=dt_article_albums.article_id");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListlianhevalue(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" * ");
            strSql.Append(" FROM  dt_article Left JOIN dt_article_attribute_value on dt_article.id=dt_article_attribute_value.article_id");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList1(int Top, string strWhere, string filedOrder)
        {
            ...
            //strSql.Append(" id,channel_id,category_id,brand_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,groupids_view,vote_id,is_top,is_red,is_hot,is_slide,is_sys,is_msg,user_name,add_time,update_time ");
            strSql.Append(" id,category_id,title,zhaiyao,img_url,img_url1,goods_recomm1,goods_recomm2,sell_price,market_price,call_index,is_top,is_hot,is_red ,sort_id FROM " + databaseprefix + "article ");
            //SELECT * FROM dt_article t1 INNER JOIN dbo.dt_article_attribute_value t2 ON t1.id=t2.article_id
            //strSql.Append(" * FROM dt_article t1 INNER JOIN dbo.dt_article_attribute_value t2 ON t1.id=t2.article_id ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList3(int Top, string strWhere, string filedOrder)
        {
            ...
            //strSql.Append(" id,channel_id,category_id,brand_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,groupids_view,vote_id,is_top,is_red,is_hot,is_slide,is_sys,is_msg,user_name,add_time,update_time ");
            strSql.Append("content FROM " + databaseprefix + "article ");
            //SELECT * FROM dt_article t1 INNER JOIN dbo.dt_article_attribute_value t2 ON t1.id=t2.article_id
            //strSql.Append(" * FROM dt_article t1 INNER JOIN dbo.dt_article_attribute_value t2 ON t1.id=t2.article_id ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList2(int Top, string strWhere, string filedOrder)
        {
            ...
            //strSql.Append(" id,channel_id,category_id,brand_id,call_index,title,link_url,img_url,seo_title,seo_keywords,seo_description,zhaiyao,content,sort_id,click,status,groupids_view,vote_id,is_top,is_red,is_hot,is_slide,is_sys,is_msg,user_name,add_time,update_time ");
            strSql.Append(" id,category_id,title,img_url FROM " + databaseprefix + "article ");
            //SELECT * FROM dt_article t1 INNER JOIN dbo.dt_article_attribute_value t2 ON t1.id=t2.article_id
            //strSql.Append(" * FROM dt_article t1 INNER JOIN dbo.dt_article_attribute_value t2 ON t1.id=t2.article_id ");
            if (strWhere.Trim() != "")
            {
        ...
        public string GetGoodsName(string searchstr)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT title FROM "+ databaseprefix + "article WHERE channel_id="+2+" and title like '%"+searchstr+"%'");
            dt = DbHelperSQL.Query(strSql.ToString()).Tables[0];
            if (dt!=null)
            {
                //for (int i = 0; i < dt.Rows.Count; i++)
                //{
                //    str += dt.Rows[i][0].ToString() + "丨";
                //}
        ...
        public string GetGoodsId(string searchstr)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("SELECT id FROM " + databaseprefix + "article WHERE channel_id=" + 2 + " and title like '%" + searchstr + "%'");
            dt = DbHelperSQL.Query(strSql.ToString()).Tables[0];
            if (dt.Rows.Count>0)
            {
        ...
        public DataSet GetList1(int channel_id, int brand_id, int pageSize, int pageIndex, string strWhere, string filedOrder, out int recordCount)
        {
            ...
            if (brand_id > 0)
            {
                if (channel_id > 0)
                {
                    strSql.Append(" and brand_id="+brand_id);
                }
                else
                {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select a.id,a.channel_id,a.call_index,a.title,a.zhaiyao,a.add_time,a.img_url,a.img_url1,b.name FROM " + databaseprefix + "article a left join " + databaseprefix + "channel b on a.channel_id=b.id");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
