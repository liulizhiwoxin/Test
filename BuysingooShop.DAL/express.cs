...
namespace BuysingooShop.DAL
{
    ...
    public partial class express
    {
        ...
        public int Add(Model.express model)
        {
            ...
            strSql.Append("title,express_code,express_fee,website,remark,sort_id,is_lock,img_url,dealer_id)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@dealer_id", SqlDbType.Int,10)};
            ...
            parameters[8].Value = model.dealer_id;
        ...
        public bool Update(Model.express model)
        {
            ...
            parameters[9].Value = model.dealer_id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 id,title,express_code,express_fee,website,remark,sort_id,is_lock,img_url,dealer_id from " + databaseprefix + "express ");
            strSql.Append(" where id=@id");
            SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)};
            parameters[0].Value = id;
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["dealer_id"].ToString() != "")
                {
                    model.dealer_id = int.Parse(ds.Tables[0].Rows[0]["dealer_id"].ToString());
                }
                return model;
            }
            else
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,title,express_code,express_fee,website,remark,sort_id,is_lock,img_url,dealer_id ");
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" id,title,express_code,express_fee,website,remark,sort_id,is_lock,img_url,dealer_id ");
            strSql.Append(" FROM " + databaseprefix + "express ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
