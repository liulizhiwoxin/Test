...
namespace BuysingooShop.Web.UI.Page
{
    public partial class register : Web.UI.BasePage
    {
        ...
        protected override void ShowPage()
        {
            ...
            username = Vincent._DTcms.DTRequest.GetQueryString("username");
            username = Vincent._DTcms.Utils.DropHTML(username);
            //检查是否关闭会员注册服务
            ...
            if (action == "checkmail")
            {
                string strcode = Vincent._DTcms.DTRequest.GetQueryString("strcode");
