...
namespace BuysingooShop.Web.UI.Page
{
    public partial class search : Web.UI.BasePage
    {
        ...
        protected override void ShowPage()
        {
            ...
            keyword = Vincent._DTcms.DTRequest.GetQueryStringValue("keyword");
            channel_name = Vincent._DTcms.DTRequest.GetQueryStringValue("channel_name");
        }
        ...
        protected DataTable get_search_list(int _pagesize, out int _totalcount)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    string link_url = get_url_rewrite(Vincent._DTcms.Utils.StrToInt(dr1["channel_id"].ToString(), 0), dr1["call_index"].ToString(), Vincent._DTcms.Utils.StrToInt(dr1["id"].ToString(), 0));
