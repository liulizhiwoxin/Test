...
namespace BuysingooShop.Web.UI.Page
{
    public partial class usercenter : Web.UI.UserPage
    {
        ...
        protected override void InitPage()
        {
            ...
            {
                //清险Session
                HttpContext.Current.Session[Vincent._DTcms.DTKeys.SESSION_USER_INFO] = null;
                //清除Cookies
                Vincent._DTcms.Utils.WriteCookie(Vincent._DTcms.DTKeys.COOKIE_USER_NAME_REMEMBER, "DTcms", -43200);
                Vincent._DTcms.Utils.WriteCookie(Vincent._DTcms.DTKeys.COOKIE_USER_PWD_REMEMBER, "DTcms", -43200);
                Vincent._DTcms.Utils.WriteCookie("UserName", "DTcms", -1);
                Vincent._DTcms.Utils.WriteCookie("Password", "DTcms", -1);
                //自动登录,跳转URL
