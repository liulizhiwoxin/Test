...
$.fn.province_city_county = function (v_province, v_city, v_county) {
    var _self = this;
    //插入3个空的下拉框
    _self.html("<select id='province' name='province' class='select_1'></select>" +
    		"<select id='city' name='city' class='select_2'></select>" +
    		"<select id='county' name='county' class='select_3'></select>");
    //分别获取3个下拉框
