<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="BuysingooShop.Admin.index" %>
    ...
    <div class="nav-right">
      <div class="icon-info">
        <span>
          ...
          <%=new BuysingooShop.BLL.manager_role().GetTitle(admin_info.role_id) %>
        </span>
      </div>
      <div class="icon-option">
        ...
        <div class="drop-box">
          <div class="arrow"></div>
          <ul class="drop-item">
            <li><a  target="_blank" href="../index.html">预览网站</a></li>
