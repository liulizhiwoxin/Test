...
namespace BuysingooShop.Web.tools
{
    ...
    public class verify_code : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            //颜色列表，用于验证码、噪线、噪点 
            //Color[] color = { Color.Black, Color.Red, Color.Blue, Color.Green, Color.Orange, Color.Brown, Color.Brown, Color.DarkBlue,Color.White };
            ...
            //写入Session
            context.Session[Vincent._DTcms.DTKeys.SESSION_CODE] = chkCode;
            //创建画布
