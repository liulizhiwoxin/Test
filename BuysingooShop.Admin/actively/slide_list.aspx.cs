...
namespace BuysingooShop.Admin.actively
{
    public partial class slide_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.prolistview = Vincent._DTcms.Utils.GetCookie("article_list_view"); //显示方式
            if (!Page.IsPostBack)
            {
                ChkAdminLevel("channel_" + this.channel_name + "_list", Vincent._DTcms.DTEnums.ActionEnum.View.ToString()); //检查权限
                //TreeBind(this.channel_id); //绑定类别
                RptBind(this.channel_id, this.category_id, CombSqlTxt(this.keywords, this.property), "sort_id asc,add_time desc,id desc");
            }
        }
        ...
        private void RptBind(int _channel_id, int _category_id,string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Vincent._DTcms.Utils.CombUrlTxt("slide_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("slide_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        {
            Vincent._DTcms.Utils.WriteCookie("article_list_view", "Txt", 14400);
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("slide_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
        ...
        {
            Vincent._DTcms.Utils.WriteCookie("article_list_view", "Img", 14400);
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("slide_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}&page={4}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property, this.page.ToString()));
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("保存排序成功啦！", Vincent._DTcms.Utils.CombUrlTxt("slide_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Vincent._DTcms.Utils.CombUrlTxt("slide_list.aspx", "channel_id={0}&category_id={1}&keywords={2}&property={3}",
                this.channel_id.ToString(), this.category_id.ToString(), this.keywords, this.property), "Success");
        }
    }
}