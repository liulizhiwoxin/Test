<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="slide_edit.aspx.cs" Inherits="BuysingooShop.Admin.actively.slide_edit"
...
<body class="mainbody">
    ...
    <!--导航栏-->
    <div class="location">
        <a href="article_list.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>
            返回列表页</span></a> <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
        <i class="arrow"></i><a href="article_list.aspx?channel_id=<%=this.channel_id %>"><span>
        ...
        <div id="floatHead" class="content-tab">
            <div class="content-tab-ul-wrap">
                <ul>
                    ...
                    <li id="field_tab_item" runat="server" visible="false"><a style="display: none;"
                        href="javascript:;" onclick="tabs(this);">扩展选项</a></li>
    ...
    <div class="tab-content">
        ...
        <dl id="div_sub_title" runat="server" visible="false">
            ...
            <dd>
                <asp:TextBox ID="field_control_sub_title" runat="server" CssClass="input normal"
        ...
        <dl id="div_goods_no" runat="server" visible="false">
            ...
            <dd>
                <asp:TextBox ID="field_control_goods_no" runat="server" CssClass="input normal" datatype="*0-100"
                    sucmsg=" " />
        ...
        <dl id="div_stock_quantity" runat="server" visible="false">
            ...
            <dd>
                <asp:TextBox ID="field_control_stock_quantity" runat="server" CssClass="input small"
                    datatype="n" sucmsg=" ">0</asp:TextBox>
        ...
        <dl id="div_market_price" runat="server" visible="false">
            ...
            <dd>
                <asp:TextBox ID="field_control_market_price" runat="server" CssClass="input small"
                    datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox>
                元
        ...
        <dl id="div_sell_price" runat="server" visible="false">
            ...
            <dd>
                <asp:TextBox ID="field_control_sell_price" runat="server" CssClass="input small"
                    datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/" sucmsg=" ">0</asp:TextBox>
                元
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:TextBox ID="txtGroupPrice" runat="server" size="10" discount='<%#Eval("discount") %>'
                            CssClass="td-input groupprice" MaxLength="10" datatype="/^(([1-9]{1}\d*)|([0]{1}))(\.(\d){1,2})?$/"
        ...
        <dl id="div_point" runat="server" visible="false">
            ...
            <dd>
                <asp:TextBox ID="field_control_point" runat="server" CssClass="input small" datatype="/^-?\d+$/"
                    sucmsg=" ">0</asp:TextBox>
