...
namespace WXPay.V3Demo
{
    ...
    public sealed class StreamReaderUtils
    {
        ...
        public static ReturnValue StreamReader(string RequestURI, Encoding Encode, bool Post, bool Expect100Continue)
        {
            ...
            //Vincent._Log.SaveMessage("第二步，模拟请求进入->StreamReader：" + RequestURI);
            ...
            try
            {
                //Vincent._Log.SaveMessage("第二步，模拟请求进入->try：" + Post);
                ...
                //Vincent._Log.SaveMessage("第二步，模拟请求进入->strReturnCode：" + strReturnCode);
            }
            catch (Exception ex)
            {
                //Vincent._Log.SaveMessage("第二步，请求接口信息出错：" + ex.Message);
