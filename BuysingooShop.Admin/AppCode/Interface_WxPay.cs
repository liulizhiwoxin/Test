...
namespace WXPay.V3Demo
{
    public class Interface_WxPay
    {
        ...
        public static string PAY_SIGNKEY = "";//paysignkey(非appkey) 
        ...
        public static string Get_RequestHtml(string openid, string Bill_No, decimal Charge_Amt, string Body = "测试充值", string PayType = "card_store")
        {
            Vincent._Log.SaveMessage("第三步 开始 openid：" + openid);
            ...
            Vincent._Log.SaveMessage("第三步 get_sign：" + get_sign);
        ...
        public static ReturnValue OAuth2_Access_Token(string Code)
        {
            ...
            //Vincent._Log.SaveMessage("第二步，1 根据code获取access_token:" + sbCode.ToString());

            ReturnValue retValue = StreamReaderUtils.StreamReader(sbCode.ToString(), Encoding.UTF8, true);

            if (retValue.HasError)
            {
                //Vincent._Log.SaveMessage("第二步，2 根据code获取access_token:" + retValue.Message);
