...
{
    public partial class source_photo_list : Web.UI.ManagePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.prolistview = Vincent._DTcms.Utils.GetCookie("source_photo_list_view"); //显示方式
            if (!Page.IsPostBack)
            {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Vincent._DTcms.Utils.CombUrlTxt("source_photo_list.aspx", "channel_id={0}&keywords={1}&page={2}",
        ...
        {
            int _pagesize;
            if (int.TryParse(Vincent._DTcms.Utils.GetCookie("source_photo_page_size"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("source_photo_list.aspx", "channel_id={0}&keywords={1}",
        ...
        {
            Vincent._DTcms.Utils.WriteCookie("source_photo_list_view", "Txt", 14400);
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("source_photo_list.aspx", "channel_id={0}&keywords={1}&page={2}",
        ...
        {
            Vincent._DTcms.Utils.WriteCookie("source_photo_list_view", "Img", 14400);
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("source_photo_list.aspx", "channel_id={0}&keywords={1}&page={2}",
                this.channel_id.ToString(), this.keywords, this.page.ToString()));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Vincent._DTcms.Utils.WriteCookie("source_photo_page_size", _pagesize.ToString(), 43200);
                }
            }
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("source_photo_list.aspx", "channel_id={0}&keywords={1}",
                this.channel_id.ToString(), this.keywords));
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(Vincent._DTcms.DTEnums.ActionEnum.Edit.ToString(), "保存" + this.channel_name + "相片素材排序"); //记录日志
            JscriptMsg("保存排序成功啦！", Vincent._DTcms.Utils.CombUrlTxt("source_photo_list.aspx", "channel_id={0}&keywords={1}",
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(Vincent._DTcms.DTEnums.ActionEnum.Edit.ToString(), "删除" + this.channel_name + "相片素材成功" + sucCount + "条，失败" + errorCount + "条"); //记录日志
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！", Vincent._DTcms.Utils.CombUrlTxt("source_photo_list.aspx", "channel_id={0}&keywords={1}",
                this.channel_id.ToString(), this.keywords), "Success");
        }
    }
}