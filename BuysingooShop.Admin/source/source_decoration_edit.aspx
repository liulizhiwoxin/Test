<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="source_decoration_edit.aspx.cs" Inherits="BuysingooShop.Admin.source.source_decoration_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="source_decoration_list.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>返回列表页</span></a>
