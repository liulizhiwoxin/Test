<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="source_font_edit.aspx.cs" Inherits="BuysingooShop.Admin.source.source_font_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="source_font_list.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="source_font_list.aspx?channel_id=<%=this.channel_id %>"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>编辑信息</span>
</div>
...
<div class="tab-content"> 
  ...
  <dl>
    <dt>值</dt>
    <dd>
      <asp:TextBox ID="txtSubTitle" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" " />
      <span class="Validform_checktip">*值最多100个字符</span>
    </dd>
  </dl>
  <dl>
    <dt>图片</dt>
