<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="coupon.aspx.cs" Inherits="BuysingooShop.Admin.finance.coupon" %>
    ...
    <asp:Repeater ID="rptList" runat="server">
        ...
        <ItemTemplate>
            <tr>
                ...
                <td>
                    <%#GetcouponStatus(Convert.ToInt32(Eval("id")))%>
                </td>
                <td>
                ...
                <td>
                    <%#string.Format("{0:g}", Eval("use_time"))%>
                </td>
                <td>
                    <%#Eval("amount")%>
                </td>
