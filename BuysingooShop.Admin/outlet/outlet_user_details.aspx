<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="outlet_user_details.aspx.cs" Inherits="BuysingooShop.Admin.outlet.outlet_user_details" %>
            ...
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="center" width="4%">昵称</th>
                        <th align="center" width="4%">用户组别</th>
                        <th align="center" width="10%">注册时间</th>
                        <th align="center" width="6%">邮箱</th>
                        <th align="center" width="6%">手机号码</th>
                   <%--     <th  align="center" width="4%" align="">余额</th>
                        <th  align="center" width="4%" align="">累积余额</th>
                        <th align="center" width="4%" align="">积分</th>--%>
                            <th width="6%">团队销售总额</th>
                        <th width="6%">佣金余额</th>
                        <th width="4%">累积积分</th>
                        <th  align="center"width="4%" align="">状态</th>
                        <th align="center" width="6%"  align="left">他的上线</th>
                        <th align="center" width="10%" align="center" >操作</th>
                    </tr>
            </HeaderTemplate>
            <ItemTemplate>
                <tr>
                    ...
                    <td  align="center"><%#Eval("nick_name")==""?"暂无信息":Eval("nick_name")%></td>
                    ...
                    <td  align="center"><%#Eval("email")==""?"暂无信息":Eval("email") %></td>
                    <td align="center"><%#Eval("mobile")==""?"暂无信息":Eval("mobile") %></td>
                ...
                <td align="center"><%#Eval("point_total")%></td>
                    ...
                    <td  align="center"><%#GetUserPreName(Convert.ToInt32(Eval("id")))   %></td>
                    <td align="center">
