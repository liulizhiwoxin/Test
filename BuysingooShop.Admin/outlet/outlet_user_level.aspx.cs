...
{
    public partial class outlet_user_level : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Vincent._DTcms.Utils.CombUrlTxt("outlet_user_level.aspx", "group_id={0}&keywords={1}&page={2}",
        ...
        {
            int _pagesize;
            if (int.TryParse(Vincent._DTcms.Utils.GetCookie("outlet_user_level"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("outlet_user_level.aspx", "group_id={0}&keywords={1}",
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Vincent._DTcms.Utils.WriteCookie("outlet_user_level", _pagesize.ToString(), 14400);
                }
            }
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("outlet_user_level.aspx", "group_id={0}&keywords={1}",
        ...
        protected void btnSmsPost_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("outlet_user_level.aspx?mobiles=" + Vincent._DTcms.Utils.UrlEncode(Vincent._DTcms.Utils.DelLastComma(str.ToString())));
            }
        }
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            JscriptMsg("删除成功" + sucCount + "条，失败" + errorCount + "条！",
                Vincent._DTcms.Utils.CombUrlTxt("outlet_user_level.aspx", "group_id={0}&keywords={1}", this.group_id.ToString(), this.keywords), "Success");
        }
