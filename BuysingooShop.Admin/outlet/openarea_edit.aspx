<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="openarea_edit.aspx.cs" Inherits="BuysingooShop.Admin.outlet.openarea_edit" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="content-tab-wrap">
            <div id="floatHead" class="content-tab">
                <div class="content-tab-ul-wrap">
                    <ul>
                        <li><a href="javascript:;" onclick="tabs(this);" class="selected">开放区域编辑</a></li>
        ...
        <div class="tab-content">
            <dl>
                ...
                <dd>
                    <div>
                        ...
                        <span class="Validform_checktip">*如果所选省份是直辖市直接保存，不用选择城市</span>
                    </div>
                </dd>
            </dl>
            <dl>
                ...
                <dd>
                    <div>
                        ...
                        <span class="Validform_checktip">*所添加开放城市不要重复</span>
                    </div>
                </dd>
            </dl>
            ...
            <dl style="display:none">
                <dt>详细地址</dt>
                <dd>
                    <asp:TextBox ID="txtaddress" runat="server" CssClass="input normal" sucmsg=" " />
            ...
            <dl style="display:none">
                <dt>店铺名称</dt>
                <dd>
                    <asp:TextBox ID="txtTitle" runat="server" CssClass="input normal" sucmsg=" " />
                    <span class="Validform_checktip"></span>
                </dd>
            </dl>
            ...
            <dl style="display:none">
                <dt>联系电话</dt>
                <dd>
                    <asp:TextBox ID="txtmobile" runat="server" CssClass="input small" style="width:200px" sucmsg=" "></asp:TextBox>
                    <span class="Validform_checktip">*</span>
                </dd>
            </dl>
            <dl style="display:none">
                <dt>店铺X坐标</dt>
                <dd>
                    <asp:TextBox ID="txtX" runat="server" CssClass="input small" sucmsg=" ">0</asp:TextBox>
            ...
            <dl style="display:none">
                <dt>店铺Y坐标</dt>
                <dd>
                    <asp:TextBox ID="txtY" runat="server" CssClass="input small" sucmsg=" ">0</asp:TextBox>
