<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="out_userlist.aspx.cs" Inherits="BuysingooShop.Admin.outlet.out_userlist" %>
        ...
        <asp:Repeater ID="rptList" runat="server">
            <HeaderTemplate>
                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="ltable">
                    <tr>
                        ...
                        <th align="left">所在省</th>
                        <th align="left">所在市</th>
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td><%#Eval("provinces")%></td>
                    <td><%#Eval("city")%></td>


                    <td><%#Convert.ToDateTime(Eval("reg_time")).ToString("yyyy-MM-dd") %></td>
                    <td><%#Eval("email")%></td>
