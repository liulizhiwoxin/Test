<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="outlet_detail.aspx.cs" Inherits="BuysingooShop.Admin.outlet.outlet_detail" ValidateRequest="false" %>
  ...
  <dl id="dlUserInfo" runat="server" visible="false">
    ...
    <dd>
      <table border="0" cellspacing="0" cellpadding="0" class="border-table" width="98%">
        <tr>
          <th width="20%">会员名</th>
          <td><asp:Label ID="lbnick_Name" runat="server" Text="-" /></td>
        </tr>
            <tr>
          <th>会员账户</th>
          <td><asp:Label ID="lbUserName" runat="server" Text="-" /></td>
        </tr>
        <tr>
          <th>会员组别</th>
