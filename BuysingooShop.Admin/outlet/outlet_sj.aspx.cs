...
{
    public partial class outlet_sj : Web.UI.ManagePage
    {
        ...
        protected string CombSqlTxt(int _status, int _payment_status, int _express_status, string _keywords)
        {
            ...
            {
                strTemp.Append(" and provinces='" + model.str_code + "' and city='" +model.str_code_rage+"'  ");
            }
            //}
            #endregion
            if (_status > 0)
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("outlet_sj.aspx", "status={0}&payment_status={1}&express_status={2}&keywords={3}",
