...
{
    public partial class outlet_user_details : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            BLL.users bll = new BLL.users();
            this.rptList.DataSource = bll.GetList(this.pageSize, this.page, _strWhere + " and id=" + id + "", _orderby, out this.totalCount);
            this.rptList.DataBind();

            //绑定页码
            txtPageNum.Text = this.pageSize.ToString();
            string pageUrl = Vincent._DTcms.Utils.CombUrlTxt("outlet_user_details.aspx", "group_id={0}&keywords={1}&page={2}",
        ...
        {
            int _pagesize;
            if (int.TryParse(Vincent._DTcms.Utils.GetCookie("outlet_user_details"), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    return _pagesize;
        ...
        {
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("outlet_user_details.aspx", "group_id={0}&keywords={1}",
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(txtPageNum.Text.Trim(), out _pagesize))
            {
                if (_pagesize > 0)
                {
                    Vincent._DTcms.Utils.WriteCookie("outlet_user_details", _pagesize.ToString(), 14400);
                }
            }
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("outlet_user_details.aspx", "group_id={0}&keywords={1}",
        ...
        protected void btnSmsPost_Click(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("outlet_user_details.aspx?mobiles=" + Vincent._DTcms.Utils.UrlEncode(Vincent._DTcms.Utils.DelLastComma(str.ToString())));
            }
        }
