<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bannergoods.aspx.cs" Inherits="BuysingooShop.Admin.article.bannergoods" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="bannergoods_edit.aspx?action=<%=Vincent._DTcms.DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="article_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    <td><%#new BuysingooShop.BLL.article_category().GetTitle(Convert.ToInt32(Eval("category_id")))%></td>
    ...
    <td align="center"><a href="bannergoods_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
...
<ItemTemplate>
    <li>
      <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
        ...
        <%#Eval("img_url1").ToString() != "" ? "<div class=\"pic\"><img src=\"../skin/default/loadimg.gif\" data-original=\"" + Eval("img_url1") + "\" /></div><i class=\"absbg\"></i>" : ""%>
        <h1><span><a href="article_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></span></h1>
        <div class="remark">
        ...
        <div class="foot">
          ...
          <a href="bannergoods_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="编辑" class="edit">编辑</a>
        </div>
      </div>
    </li>
</ItemTemplate>
