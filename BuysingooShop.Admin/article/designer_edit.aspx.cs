...
namespace BuysingooShop.Admin.article
{
    public partial class designer_edit : Web.UI.ManagePage
    {
        ...
        private void TreeBind(int _channel_id)
        {
            ...
            this.ddlCategoryId.Items.Add(new ListItem("设计师", "62"));
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == Vincent._DTcms.DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改信息成功！", "designer_list.aspx?channel_id=" + this.channel_id, "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加信息成功！", "designer_list.aspx?channel_id=" + this.channel_id, "Success");
            }
        } 
