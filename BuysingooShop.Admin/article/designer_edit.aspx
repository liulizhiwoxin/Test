<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="designer_edit.aspx.cs" Inherits="BuysingooShop.Admin.article.designer_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="designer_list.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="designer_list.aspx?channel_id=<%=this.channel_id %>"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>编辑信息</span>
</div>
...
<div class="tab-content">
  ...
  <dl ID="div_sub_title" runat="server" Visible="False">
    <dt><asp:Label ID="div_sub_title_title" runat="server" Text="擅长风格" /></dt>
    <dd>
  ...
  <dl ID="div_sell_price" runat="server">
