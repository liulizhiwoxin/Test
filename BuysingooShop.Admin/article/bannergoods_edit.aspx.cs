...
{
    public partial class bannergoods_edit : Web.UI.ManagePage
    {
        ...
        private void ShowInfo(int _id)
        {
            ...
            goods_recomm1.Text = model.goods_recomm1;
            goods_recomm2.Text = model.goods_recomm2;
        ...
        private bool DoAdd()
        {
            ...
            model.goods_recomm1 = goods_recomm1.Text.Trim();
            model.goods_recomm2 = goods_recomm2.Text.Trim();
            model.link_url = txtLinkUrl.Text.Trim();
            model.img_url = txtImgUrl.Text;
            model.img_url1 = txtImgUrl1.Text;
            ...
            model.is_hot = 0;
            model.is_slide = 0;
            model.market_price = decimal.Parse(field_control_market_price.Text.Trim());
            model.sell_price = decimal.Parse(field_control_sell_price.Text.Trim());
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            if (action == Vincent._DTcms.DTEnums.ActionEnum.Edit.ToString()) //修改
            {
                ...
                JscriptMsg("修改信息成功！", "bannergoods.aspx?channel_id=" + this.channel_id, "Success");
            }
            else //添加
            {
                ...
                JscriptMsg("添加信息成功！", "bannergoods.aspx?channel_id=" + this.channel_id, "Success");
            }
        }
