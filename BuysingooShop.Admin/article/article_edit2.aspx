<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="article_edit2.aspx.cs" Inherits="BuysingooShop.Admin.article.article_edit2" ValidateRequest="false" %>
...
<div id="field_tab_content" runat="server" class="tab-content"  Visible="False" style="display: none;">
      <dl ID="div_damizhonglei" runat="server" class="multi-radio-tr multi-checkbox-tr"  visible="false">
        <dt><asp:Label ID="div_damizhonglei_title" runat="server" Text="大米种类" /></dt>
        <dd>
      ...
      <dl ID="div_zhongliang" runat="server" class="multi-radio-tr multi-checkbox-tr" visible="false">
        <dt><asp:Label ID="div_zhongliang_title" runat="server" Text="重量" /></dt>
        <dd>
