<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="designer_list.aspx.cs" Inherits="BuysingooShop.Admin.article.designer_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="designer_edit.aspx?action=<%=Vincent._DTcms.DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></a></li>
...
<%--        <div class="rule-single-select">
    ...
    <div class="r-list">
      ...
      <asp:LinkButton ID="lbtnSearch" runat="server" CssClass="btn-search" Visible="False" onclick="btnSearch_Click">查询</asp:LinkButton>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="designer_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></td>
    ...
    <td align="center"><a href="designer_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
...
<ItemTemplate>
    <li>
      <div class="details<%#Eval("img_url").ToString() != "" ? "" : " nopic"%>">
        ...
        <h1><span><a href="designer_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("title")%></a></span></h1>
        <div class="remark">
        ...
        <div class="foot">
          ...
          <a href="designer_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="编辑" class="edit">编辑</a>
        </div>
      </div>
    </li>
</ItemTemplate>
