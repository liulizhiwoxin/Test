<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="bannergoods_edit.aspx.cs" Inherits="BuysingooShop.Admin.article.bannergoods_edit" ValidateRequest="false" %>
...
<!--导航栏-->
<div class="location">
  <a href="bannergoods.aspx?channel_id=<%=this.channel_id %>" class="back"><i></i><span>返回列表页</span></a>
  <a href="../center.aspx" class="home"><i></i><span>首页</span></a>
  <i class="arrow"></i>
  <a href="bannergoods.aspx?channel_id=<%=this.channel_id %>"><span>内容管理</span></a>
  <i class="arrow"></i>
  <span>编辑信息</span>
</div>
...
<div class="tab-content">
  ...
  <dl>
    ...
    <dt>商品介绍1</dt>
    <dd>
      <asp:TextBox ID="goods_recomm1" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" " />
    ...
    <dt>商品介绍2</dt>
    <dd>
      <asp:TextBox ID="goods_recomm2" runat="server" CssClass="input normal" datatype="*2-100" sucmsg=" " />
      <span class="Validform_checktip">*</span>
    </dd>
  </dl>
...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">*左边：zuobian 405*495；右上：youshang 597*239；右下1：youxia1 284*237；右下2：youxia2 284*237；底部：dibu 250*250</span>
    </dd>
  </dl>
  <dl>
    <dt>URL链接</dt>
