<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="comment_edit.aspx.cs" Inherits="BuysingooShop.Admin.article.comment_edit" ValidateRequest="false" %>
...
<div class="content-tab-wrap">
  <div id="floatHead" class="content-tab">
    <div class="content-tab-ul-wrap">
      <ul>
        <li><a href="javascript:;" onclick="tabs(this);" class="selected">查看评论信息</a></li>
      </ul>
    </div>
  </div>
</div>
...
<div class="tab-content">
  <dl style="display:none;">
    <dt>文章标题</dt>
    <dd><%=new BuysingooShop.BLL.article().GetTitle(model.article_id)%></dd>
  </dl>
  <dl>
    <dt>姓名</dt>
