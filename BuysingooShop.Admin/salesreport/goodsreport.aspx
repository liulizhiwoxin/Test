<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="goodsreport.aspx.cs" Inherits="BuysingooShop.Admin.salesreport.goodsreport" %>
...
<body class="mainbody">
    <form id="form1" runat="server">
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <FooterTemplate>
                <%#rptList.Items.Count == 0 ? "<tr><td align=\"center\" colspan=\"5\">暂无记录</td></tr>" : ""%><tr><td>订单金额统计：<%:total_amount%></td><td style="display:none">优惠券统计：<%:coupon_amount%></td><td style="display:none">退款统计：<%:refund_amount%></td></tr>
</table>
            </FooterTemplate>
        </asp:Repeater>
        <!--/列表-->
