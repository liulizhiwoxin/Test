<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_accept.aspx.cs" Inherits="BuysingooShop.Admin.dialog.dialog_accept" %>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        if ($("#txtMobile").val() == "") {
            W.$.dialog.alert('请填写联系方式！', function () { $("#txtMobile").focus(); }, api);
            return false;
        }
        //下一步，AJAX提交表单
        var postData = {
