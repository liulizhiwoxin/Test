<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dialog_express.aspx.cs" Inherits="BuysingooShop.Admin.dialog.dialog_express" %>
...
<script type="text/javascript">
    ...
    function submitForm() {
        ...
        //组合参数
        var postData = {
            "order_no": $("#hiddOrderNo").val(), "edit_type": "order_express",
            "express_id": $("#ddlExpressId").val(), "express_no": $("#txtExpressNo").val()
        };
        //判断是否需要输入物流单号
        if ($("#txtExpressNo").val() == "") {
            W.$.dialog.confirm('请填写物流单号？',
            function () {
                //发送AJAX请求
