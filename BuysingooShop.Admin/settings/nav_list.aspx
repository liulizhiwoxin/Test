<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="nav_list.aspx.cs" Inherits="BuysingooShop.Admin.settings.nav_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="nav_edit.aspx?action=<%=Vincent._DTcms.DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td style="white-space:nowrap;word-break:break-all;overflow:hidden;">
      ...
      <a href="nav_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("title")%></a>
    ...
    <td align="center" style="white-space:nowrap;word-break:break-all;overflow:hidden;">
      <a href="nav_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Add %>&id=<%#Eval("id")%>">添加子级</a>
      <a href="nav_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a>
    </td>
  </tr>
</ItemTemplate>
<FooterTemplate>
