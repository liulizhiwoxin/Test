<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="url_rewrite_list.aspx.cs" Inherits="BuysingooShop.Admin.settings.url_rewrite_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="url_rewrite_edit.aspx?action=<%=Vincent._DTcms.DTEnums.ActionEnum.Add %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td align="center"><a href="url_rewrite_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&name=<%#Eval("name")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
