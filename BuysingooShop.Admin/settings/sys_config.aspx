<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sys_config.aspx.cs" Inherits="BuysingooShop.Admin.settings.sys_config" ValidateRequest="false" %>
...
<div class="tab-content" style="display:none">
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="memberstatus" runat="server" Checked="False" />
      </div>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="rechangestatus" runat="server" Checked="False" />
      </div>
      <span class="Validform_checktip">*关闭后会员不能参加充值活动</span>
    </dd>
  </dl>
  <dl>
    <dt>开启评论审核</dt>
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="commentstatus" runat="server"  Checked="False"/>
      </div>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="logstatus" runat="server"  Checked="False"/>
      </div>
  ...
  <dl>
    ...
    <dd>
      <div class="rule-single-checkbox">
          <asp:CheckBox ID="webstatus" runat="server"  Checked="False"/>
      </div>
...
<div class="tab-content" style="display:none">
  <dl>
    ...
    <dd>
      ...
      <span class="Validform_checktip">尚未申请？<a href="http://sms.BuysingooShop.net" target="_blank">请点击这里注册</a></span>
    </dd>
  </dl>
  <dl>
    <dt>平台登录账户</dt>
  ...
  <dl>
    ...
    <dd>
      ...
      如果您尚未申请开通，<a href="http://sms.BuysingooShop.net" target="_blank">请点击这里注册</a>成功后填写您的用户名和密码均可正常使用。
    </dd>
  </dl>
</div>
<!--/手机短信设置-->
