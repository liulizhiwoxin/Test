<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_edit.aspx.cs" Inherits="BuysingooShop.Admin.users.user_edit" ValidateRequest="false" %>
...
<div class="tab-content">
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="DropDownList1" runat="server" datatype="*" errormsg="请选择上级" sucmsg=" ">
    ...
    <dd>
      <div class="rule-single-select">
        <asp:DropDownList id="ddlGroupId" runat="server" datatype="*" errormsg="请选择组别" sucmsg=" ">
            <asp:ListItem Value="0">新用户</asp:ListItem>
...
<div class="tab-content" style="display:none;">
  <dl>
    <dt>账户金额</dt>
    <dd>
      <asp:TextBox ID="txtAmount" runat="server" CssClass="input small" sucmsg=" ">0</asp:TextBox> 元
