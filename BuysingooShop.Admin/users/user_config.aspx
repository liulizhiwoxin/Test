<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_config.aspx.cs" Inherits="BuysingooShop.Admin.users.user_config" ValidateRequest="false" %>
...
<div class="tab-content">
  ...
  <dl>
    <dt>会员直销模式</dt>
    <dd>
      <asp:TextBox ID="directvip" runat="server" CssClass="input small" datatype="n" sucmsg=" " Text="0" /> 
      <span class="Validform_checktip">*会员直销有效的层数，0为不限制</span>
    </dd>
  </dl>
  <dl>
    <dt>IP注册间隔限制</dt>
