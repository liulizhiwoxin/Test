...
namespace BuysingooShop.Admin.users
{
    public partial class point_log : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Vincent._DTcms.Utils.CombUrlTxt("point_log.aspx", "keywords={0}&page={1}", this.keywords, "__id__");
        ...
        {
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("point_log.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void txtPageNum_TextChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("point_log.aspx", "keywords={0}", this.keywords));
        }
