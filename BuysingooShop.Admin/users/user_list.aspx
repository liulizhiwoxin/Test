<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_list.aspx.cs" Inherits="BuysingooShop.Admin.users.user_list" %>
        ...
        <asp:Repeater ID="rptList" runat="server">
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td align="center"><%#Eval("pay_time")%></td>
                    ...
                    <td align="center">
                        <%--<a href="user_list_level.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">他的下线</a>&nbsp;&nbsp;--%>
                        <a href="user_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">修改</a></td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
