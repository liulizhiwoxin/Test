...
namespace BuysingooShop.Admin.users
{
    public partial class user_list : Web.UI.ManagePage
    {
        ...
        private void RptBind(string _strWhere, string _orderby)
        {
            ...
            string pageUrl = Vincent._DTcms.Utils.CombUrlTxt("user_list.aspx", "group_id={0}&keywords={1}&page={2}",
        ...
        {
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("user_list.aspx", "group_id={0}&keywords={1}",
