<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_list.aspx.cs" Inherits="BuysingooShop.Admin.order.order_list" %>
                    ...
                    <div class="menu-list">
                        <div class="rule-single-select">
                            <asp:DropDownList ID="ddlStatus" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged">
                                ...
                                <%--<asp:ListItem Value="7">退货中</asp:ListItem>--%>
                            </asp:DropDownList>
                        </div>
            ...
            <ItemTemplate>
                <tr>
                    <td align="center">
                        ...
                        <input type="hidden" value="<%#Eval("order_no")%>" />
                        <asp:HiddenField ID="hidId" Value='<%#Eval("id")%>' runat="server" />
                    </td>
                    <td><a href="order_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>"><%#Eval("order_no")%></a></td>
                     <td align="left"><%#Getusernick_name(Convert.ToInt32(Eval("user_id")))%></td>
                    <td align="left"><%#Eval("user_name").ToString() == "" ? "匿名用户" : Eval("user_name").ToString()%></td>
                    ...
                    <td align="center"><a href="order_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&id=<%#Eval("id")%>">订单详细</a>&nbsp;&nbsp;</td>
                </tr>
            </ItemTemplate>
            <FooterTemplate>
