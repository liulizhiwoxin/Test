<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="order_trans.aspx.cs" Inherits="BuysingooShop.Admin.order.order_trans" %>
  ...
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        ...
        <li><a class="sendout" href="javascript:;" ><i></i><span>发货</span></a></li>      </ul>
    </div>
    <div class="r-list">
