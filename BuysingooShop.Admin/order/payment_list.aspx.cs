...
namespace BuysingooShop.Admin.order
{
    public partial class payment_list : Web.UI.ManagePage
    {
        ...
        {
            Response.Redirect(Vincent._DTcms.Utils.CombUrlTxt("payment_list.aspx", "keywords={0}", txtKeywords.Text));
        }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            AddAdminLog(Vincent._DTcms.DTEnums.ActionEnum.Edit.ToString(), "保存支付方式排序"); //记录日志
            JscriptMsg("保存排序成功！", Vincent._DTcms.Utils.CombUrlTxt("payment_list.aspx", "keywords={0}", this.keywords), "Success");
        }
