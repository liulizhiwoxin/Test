<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="brand_list.aspx.cs" Inherits="BuysingooShop.Admin.good.brand_list" %>
...
<div class="toolbar-wrap">
  <div id="floatHead" class="toolbar">
    <div class="l-list">
      <ul class="icon-list">
        <li><a class="add" href="brand_edit.aspx?action=<%=Vincent._DTcms.DTEnums.ActionEnum.Add %>&channel_id=<%=this.channel_id %>"><i></i><span>新增</span></a></li>
...
<ItemTemplate>
  <tr>
    ...
    <td><a href="brand_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("brandName")%></a></td>
    <td><%#Eval("remark")%></td>
    ...
    <td align="center"><a href="brand_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>">修改</a></td>
  </tr>
</ItemTemplate>
<FooterTemplate>
...
<ItemTemplate>
    <li>
      <div class="details<%#Eval("brandImgUrl").ToString() != "" ? "" : " nopic"%>">
        ...
        <%#Eval("brandImgUrl").ToString() != "" ? "<div class=\"pic\"><img src=\"../skin/default/loadimg.gif\" data-original=\"" + Eval("brandImgUrl") + "\" /></div><i class=\"absbg\"></i>" : ""%>
        <h1><span><a href="brand_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>"><%#Eval("brandName")%></a></span></h1>
        <div class="remark">
          <%#Eval("remark").ToString() == "" ? "暂无品牌说明..." : Eval("remark").ToString()%>
        </div>
        <div class="tools">
        ...
        <div class="foot">
          ...
          <a href="brand_edit.aspx?action=<%#Vincent._DTcms.DTEnums.ActionEnum.Edit %>&channel_id=<%#this.channel_id %>&id=<%#Eval("id")%>" title="编辑" class="edit">编辑</a>
        </div>
      </div>
    </li>
</ItemTemplate>
